...
<aside {{ ($attributes ?? new \Illuminate\View\ComponentAttributeBag)->merge(['class' => 'flex h-full w-72 flex-col bg-[#03123F] border-r border-[#1E3A8A]/40 text-slate-100 shadow-xl']) }}>
