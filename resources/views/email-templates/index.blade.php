    ...
    <div class="p-6 space-y-6" x-data="{ viewMode: localStorage.getItem('email_template_view') || 'grid' }">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-200/80 shadow-sm">
            ...
            <div class="flex flex-wrap items-center gap-2.5">
                ...
                <a href="{{ route('settings.email-header') }}" class="inline-flex items-center gap-2 bg-amber-50 hover:bg-amber-100 text-amber-900 border border-amber-200/80 text-sm font-semibold px-4 py-2.5 rounded-xl shadow-sm transition duration-150">
                    <svg class="w-4 h-4 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                    </svg>
                    <span>En-tête & Logo</span>
                </a>
